defmodule TictactoeWeb.TictactoeLive do
  ...
  defp has_won(board) do
    case board do
      ...
      ## vertical + horizontal
      ### L shape
      [@p1, @p1, @p1, @p1, _, _, @p1, _, _] -> {@p1, [0, 1, 2, 3, 6]}
      [@p1, @p1, @p1, _, _, @p1, _, _, @p1] -> {@p1, [0, 1, 2, 5, 8]}
      [_, _, @p1, _, _, @p1, @p1, @p1, @p1] -> {@p1, [2, 5, 6, 7, 8]}
      [@p1, _, _, @p1, _, _, @p1, @p1, @p1] -> {@p1, [0, 3, 6, 7, 8]}
      ### T shape
      [@p1, @p1, @p1, _, @p1, _, _, @p1, _] -> {@p1, [0, 1, 2, 4, 7]}
      [@p1, _, _, @p1, @p1, @p1, @p1, _, _] -> {@p1, [0, 3, 4, 5, 6]}
      [_, @p1, _, _, @p1, _, @p1, @p1, @p1] -> {@p1, [1, 4, 6, 7, 8]}
      [_, _, @p1, @p1, @p1, @p1, _, _, @p1] -> {@p1, [2, 3, 4, 5, 8]}
      ## horizontal + diagonals
      [@p1, @p1, @p1, _, @p1, _, _, _, @p1] -> {@p1, [0, 1, 2, 4, 8]}
      [@p1, _, _, @p1, @p1, @p1, _, _, @p1] -> {@p1, [0, 3, 4, 5, 8]}
      [@p1, _, _, _, @p1, _, @p1, @p1, @p1] -> {@p1, [0, 4, 6, 7, 8]}
      [@p1, @p1, @p1, _, @p1, _, @p1, _, _] -> {@p1, [0, 1, 2, 4, 6]}
      [_, _, @p1, @p1, @p1, @p1, @p1, _, _] -> {@p1, [2, 3, 4, 5, 6]}
      [_, _, @p1, _, @p1, _, @p1, @p1, @p1] -> {@p1, [2, 4, 6, 7, 8]}
      ## vertical + diagonals
      [@p1, _, _, @p1, @p1, _, @p1, _, @p1] -> {@p1, [0, 3, 4, 6, 8]}
      [@p1, @p1, _, _, @p1, _, _, @p1, @p1] -> {@p1, [0, 1, 4, 7, 8]}
      [@p1, _, @p1, _, @p1, @p1, _, _, @p1] -> {@p1, [0, 2, 4, 5, 8]}
      [@p1, _, @p1, @p1, @p1, _, @p1, _, _] -> {@p1, [0, 2, 3, 4, 6]}
      [_, @p1, @p1, _, @p1, _, @p1, @p1, _] -> {@p1, [1, 2, 4, 6, 7]}
      [_, _, @p1, _, @p1, @p1, @p1, _, @p1] -> {@p1, [2, 4, 5, 6, 8]}
      # single line winning
      ## horizontals
      [@p1, @p1, @p1 | _] -> {@p1, [0, 1, 2]}
      [@p2, @p2, @p2 | _] -> {@p2, [0, 1, 2]}
